...
async function triggerFeePostNow(): Promise<object> {
  return runDailyFeePost(console);
}
...
export async function registerAdminRoutes(app: FastifyInstance): Promise<void> {
  ...
  // Manual fee post trigger
  app.post("/api/admin/fee-post/trigger", async (_request, reply) => {
    try { return await triggerFeePostNow(); }
