...
const TIMEZONE_LABELS: Record<string, Record<string, string>> = {
  "Europe/Berlin":      { de: "Berlin (MEZ/MESZ)",      en: "Berlin (CET/CEST)",    es: "Berlín (CET/CEST)",     ko: "베를린 (CET/CEST)",    zh: "柏林 (CET/CEST)",      ru: "Берлин (CET/CEST)"      , pt: "Berlim (CET/CEST)"      },
  "Europe/London":      { de: "London (GMT/BST)",        en: "London (GMT/BST)",     es: "Londres (GMT/BST)",     ko: "런던 (GMT/BST)",       zh: "伦敦 (GMT/BST)",        ru: "Лондон (GMT/BST)"       , pt: "Londres (GMT/BST)"      },
  "Europe/Paris":       { de: "Paris (MEZ/MESZ)",        en: "Paris (CET/CEST)",     es: "París (CET/CEST)",      ko: "파리 (CET/CEST)",      zh: "巴黎 (CET/CEST)",       ru: "Париж (CET/CEST)"       , pt: "Paris (CET/CEST)"      },
  "Europe/Vienna":      { de: "Wien (MEZ/MESZ)",         en: "Vienna (CET/CEST)",    es: "Viena (CET/CEST)",      ko: "빈 (CET/CEST)",        zh: "维也纳 (CET/CEST)",     ru: "Вена (CET/CEST)"        , pt: "Viena (CET/CEST)"      },
  "Europe/Zurich":      { de: "Zürich (MEZ/MESZ)",       en: "Zurich (CET/CEST)",    es: "Zúrich (CET/CEST)",     ko: "취리히 (CET/CEST)",    zh: "苏黎世 (CET/CEST)",     ru: "Цюрих (CET/CEST)"       , pt: "Zurique (CET/CEST)"      },
  "Europe/Amsterdam":   { de: "Amsterdam (MEZ/MESZ)",    en: "Amsterdam (CET/CEST)", es: "Ámsterdam (CET/CEST)",  ko: "암스테르담 (CET/CEST)", zh: "阿姆斯特丹 (CET/CEST)", ru: "Амстердам (CET/CEST)"   , pt: "Amsterdã (CET/CEST)"      },
  "Europe/Warsaw":      { de: "Warschau (MEZ/MESZ)",     en: "Warsaw (CET/CEST)",    es: "Varsovia (CET/CEST)",   ko: "바르샤바 (CET/CEST)",  zh: "华沙 (CET/CEST)",       ru: "Варшава (CET/CEST)"      , pt: "Varsóvia (CET/CEST)"      },
  "Europe/Stockholm":   { de: "Stockholm (MEZ/MESZ)",    en: "Stockholm (CET/CEST)", es: "Estocolmo (CET/CEST)",  ko: "스톡홀름 (CET/CEST)",  zh: "斯德哥尔摩 (CET/CEST)", ru: "Стокгольм (CET/CEST)"   , pt: "Estocolmo (CET/CEST)"      },
  "Europe/Moscow":      { de: "Moskau (MSK)",            en: "Moscow (MSK)",         es: "Moscú (MSK)",           ko: "모스크바 (MSK)",       zh: "莫斯科 (MSK)",          ru: "Москва (MSK)"            , pt: "Moscou (MSK)"      },
  "Asia/Dubai":         { de: "Dubai (GST)",             en: "Dubai (GST)",          es: "Dubái (GST)",           ko: "두바이 (GST)",         zh: "迪拜 (GST)",             ru: "Дубай (GST)"             , pt: "Dubai (GST)"      },
  "Asia/Kolkata":       { de: "Kolkata (IST)",           en: "Kolkata (IST)",        es: "Calcuta (IST)",         ko: "콜카타 (IST)",         zh: "加尔各答 (IST)",         ru: "Калькутта (IST)"         , pt: "Calcutá (IST)"      },
  "Asia/Singapore":     { de: "Singapur (SGT)",          en: "Singapore (SGT)",      es: "Singapur (SGT)",        ko: "싱가포르 (SGT)",       zh: "新加坡 (SGT)",           ru: "Сингапур (SGT)"          , pt: "Singapura (SGT)"      },
  "Asia/Tokyo":         { de: "Tokio (JST)",             en: "Tokyo (JST)",          es: "Tokio (JST)",           ko: "도쿄 (JST)",           zh: "东京 (JST)",             ru: "Токио (JST)"             , pt: "Tóquio (JST)"      },
  "Asia/Seoul":         { de: "Seoul (KST)",             en: "Seoul (KST)",          es: "Seúl (KST)",            ko: "서울 (KST)",           zh: "首尔 (KST)",             ru: "Сеул (KST)"              , pt: "Seul (KST)"      },
  "Asia/Shanghai":      { de: "Shanghai (CST)",          en: "Shanghai (CST)",       es: "Shanghái (CST)",        ko: "상하이 (CST)",         zh: "上海 (CST)",             ru: "Шанхай (CST)"            , pt: "Xangai (CST)"      },
  "Australia/Sydney":   { de: "Sydney (AEST/AEDT)",      en: "Sydney (AEST/AEDT)",   es: "Sídney (AEST/AEDT)",    ko: "시드니 (AEST/AEDT)",   zh: "悉尼 (AEST/AEDT)",      ru: "Сидней (AEST/AEDT)"      , pt: "Sydney (AEST/AEDT)"      },
  "Pacific/Auckland":   { de: "Auckland (NZST/NZDT)",    en: "Auckland (NZST/NZDT)", es: "Auckland (NZST/NZDT)",  ko: "오클랜드 (NZST/NZDT)", zh: "奥克兰 (NZST/NZDT)",   ru: "Окленд (NZST/NZDT)"     , pt: "Auckland (NZST/NZDT)"      },
  "UTC":                { de: "UTC / Greenwich",         en: "UTC / Greenwich",      es: "UTC / Greenwich",       ko: "UTC / 그리니치",       zh: "UTC / 格林尼治",         ru: "UTC / Гринвич"           , pt: "UTC / Greenwich"      },
  "America/Sao_Paulo":  { de: "São Paulo (BRT)",         en: "São Paulo (BRT)",      es: "São Paulo (BRT)",       ko: "상파울루 (BRT)",       zh: "圣保罗 (BRT)",           ru: "Сан-Паулу (BRT)"         , pt: "São Paulo (BRT)"      },
  "America/New_York":   { de: "New York (ET)",           en: "New York (ET)",        es: "Nueva York (ET)",       ko: "뉴욕 (ET)",            zh: "纽约 (ET)",              ru: "Нью-Йорк (ET)"           , pt: "Nova York (ET)"      },
  "America/Chicago":    { de: "Chicago (CT)",            en: "Chicago (CT)",         es: "Chicago (CT)",          ko: "시카고 (CT)",          zh: "芝加哥 (CT)",            ru: "Чикаго (CT)"             , pt: "Chicago (CT)"      },
  "America/Denver":     { de: "Denver (MT)",             en: "Denver (MT)",          es: "Denver (MT)",           ko: "덴버 (MT)",            zh: "丹佛 (MT)",              ru: "Денвер (MT)"             , pt: "Denver (MT)"      },
  "America/Los_Angeles":{ de: "Los Angeles (PT)",        en: "Los Angeles (PT)",     es: "Los Ángeles (PT)",      ko: "로스앤젤레스 (PT)",    zh: "洛杉矶 (PT)",            ru: "Лос-Анджелес (PT)"       , pt: "Los Angeles (PT)"      },
};
